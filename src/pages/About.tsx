        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-lg leading-relaxed text-gray-600">
              La Clínica Oftalmológica Pérez Salvador fue fundada por el
              Dr. José Luis Pérez-Salvador y hoy continúa su legado el
              Dr. Eduardo Pérez-Salvador, en activo, manteniendo el mismo
              compromiso con una atención especializada, rigurosa y humana.
              Nuestra filosofía se basa en tratar a cada paciente como persona,
              no como un caso clínico, y en mantenernos a la vanguardia de la
              tecnología diagnóstica y quirúrgica.
            </p>
          </div>
