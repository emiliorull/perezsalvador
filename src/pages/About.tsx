      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-lg leading-relaxed text-gray-600">Ante todo somos médicos oftalmólogos y no una empresa, cadena o franquicia dedicada a explotar la inversión realizada con un objetivo primordial empresarial y económico. Nuestro objetivo es el bienestar y la salud de nuestros pacientes. Para ello, disponemos de la tecnología de vanguardia más avanzada, personalizando el tratamiento de cada paciente y buscando la mejor calidad de visión.</p>
          </div>
